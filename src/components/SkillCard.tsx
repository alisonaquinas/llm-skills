    ...
    <article className="rounded-xl border border-gray-200 bg-white p-4 transition-colors hover:border-brand-500 hover:shadow-md dark:border-gray-800 dark:bg-gray-900 dark:hover:border-brand-400 sm:p-5">
      <div className="flex items-start gap-3">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
            <h3 className="break-words font-semibold">
              <Link
                ...
                className="text-gray-900 hover:text-brand-600 dark:text-white dark:hover:text-brand-300"
              >
                {skill.name}
              </Link>
            </h3>
        ...
        <div className="mt-1 flex shrink-0 items-center gap-2">
          ...
          <svg
            className="hidden h-4 w-4 text-gray-300 dark:text-gray-600 sm:block"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
